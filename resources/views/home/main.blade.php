    ...
    <div class="container">
        <div class="row">
            <nav class="footer-nav">
                <ul>
                    <li style="padding:0;">
                        <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=37172902372214" target="_blank"><img style="width: 20px;display: inline-block;height: 20px;" data-src="//img.alicdn.com/tfs/TB1..50QpXXXXX7XpXXXXXXXXXX-40-40.png" src="//img.alicdn.com/tfs/TB1..50QpXXXXX7XpXXXXXXXXXX-40-40.png"></a>
                    </li>
                    <li>
                        <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=37172902372214" class="text-secondary" target="_blank">{{$configs['base.websecurity_keep']}}</a>
                    </li>
                    <li>
